...
#         weight_clip = F.hardtanh(self.weight,
#                            min_val = -self.half_lvls * self.step_size.item(),
#                            max_val = self.half_lvls * self.step_size.item())
        
        weight_quan = quantize(self.weight,
                               self.step_size, self.half_lvls)*self.step_size
